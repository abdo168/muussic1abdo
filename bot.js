...
const developers = ["339863048611168256"]
const adminprefix = "+";
...
const YossiF = member.guild.channels.get("477702574447919106");//ايدي الشات
if(!YossiF) return;
if(YossiF) {
...
client.login("NTE1MTgzNzk4ODc5NjQ5ODAz.Dtha_A.bEfDvbDJYoSk9WLXBGWIy_uQAuA");